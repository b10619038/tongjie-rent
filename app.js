...
const APP_STAMP = "2026-08-30-02-20";
const TENANT_ROSTER_VER = "20260829-2230";
const FACTORY_ROSTER_VER = "20260828-2030";
const CHANGELOG = [
  { ver: APP_STAMP, items: ["套房出租率照片裁切再往左一點"] },
  ...
  return `<div class="dash">
    ...
    <div class="dash-hero rings">
      <div class="card ring-card ring-stack">
        <div class="ring-row"><div class="ring-wrap"><div class="ring sky ${ui.keepScroll ? "" : "spin-in"} delay" style="--p:${studioOcc.occ}"></div><b>${studioOcc.occ}%</b></div><div><div class="k">套房出租率</div><div class="small">滿租 ${studioOcc.rented} · 空置 ${studioOcc.vacant} · 維修 ${studioOcc.repairing}</div></div><img class="occ-shot" src="images/occ-studio.jpg?v=0220" alt="套房"></div>
