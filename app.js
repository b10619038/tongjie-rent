...
const APP_VERSION = "2026-08-30-上午12:58";
const TENANT_ROSTER_VER = "20260829-2230";
const FACTORY_ROSTER_VER = "20260828-2030";
const CHANGELOG = [
  { ver: "2026-08-30-上午12:58", items: ["調色盤新增極淺灰"] },
    ...
    errand: `<form class="card card-body tenant-slim${(ui.errandOpen || ui.bankOpen) ? " open" : ""}" id="errand-form" autocomplete="off">
      ...
      <div class="tenant-slim-body">
        <div class="tenant-slim-inner">
          <p class="small" style="margin-top:10px">去廠房或公司收現金，直接打字就能記，不一定要拍照。一次拍很多本也可以，分不出公司或銀行時會問你。同一筆錢之後存進銀行會自動對帳。</p>
          <label class="field"><span>這次做了什麼</span>
