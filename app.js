...
const APP_STAMP = "2026-08-31-01-39";
const APP_EDIT_COUNT = 296;
...
const CHANGELOG = [
  { ver: APP_STAMP, items: ["三聯發票日期紅字往右1.5公分"] },
...
function invoiceCopyHtml(r, t, copyName) {
  ...
  if (triple) {
    ...
    const boxes = taxLines.slice(0, 8).map((x, i) => {
      ...
      return at(W, H, x + 55, 245, rgt - x - 16, 30, "invoiceTax" + i, taxId[i] || "", "inv-tid");
    }).join("");
    ...
    return `<section class="inv-photo triple">
      ...
      ${boxes}
      ${at(W, H, 1062, 232, 78, 32, "invoiceY", y)}
      ${at(W, H, 1188, 232, 68, 32, "invoiceMo", mo)}
      ${at(W, H, 1298, 232, 72, 32, "invoiceDay", day)}
