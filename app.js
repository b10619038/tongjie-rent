...
const APP_STAMP = "2026-09-02-22-24";
const APP_EDIT_COUNT = 545;
...
const CHANGELOG = [
  { ver: APP_STAMP, items: ["登入畫面刷新不再重複滑入圖塊"] },
...
function paintApp() {
  ...
  if (!ui.role) {
    ...
    const overlays = !!(ui.themeOpen || ui.notifyGuide || ui.installSheet || ui.updateNotes || toastHtml);
